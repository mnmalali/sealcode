...
Desktop application and browser-based app issues, including `sealcode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core sealcode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Sealcode Zen, Sealcode Go, and billing issues.
