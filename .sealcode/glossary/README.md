...
Use this folder for locale-specific translation guidance that supplements `.sealcode/agent/translator.md`.
...
- PR #12345: https://github.com/mnmalali/sealcode/pull/12345

## Do Not Translate (Locale Additions)

- `Sealcode` (preserve casing)
