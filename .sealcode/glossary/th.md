...
- PR #10809: https://github.com/mnmalali/sealcode/pull/10809
- PR #11496: https://github.com/mnmalali/sealcode/pull/11496

## Do Not Translate (Locale Additions)

- `Sealcode` (preserve casing in prose; keep `sealcode` only in commands, package names, paths, or code)
- `Sealcode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
