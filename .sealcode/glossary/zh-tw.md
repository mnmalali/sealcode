...
- PR #13942: https://github.com/mnmalali/sealcode/pull/13942

## Do Not Translate (Locale Additions)

- `Sealcode` (preserve casing in prose; keep `sealcode` only when it is part of commands, package names, paths, or code)
- `Sealcode Zen`
- `Sealcode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `sealcode` in prose when referring to the product name; use `Sealcode`
