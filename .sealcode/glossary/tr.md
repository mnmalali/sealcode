...
- PR #15835: https://github.com/mnmalali/sealcode/pull/15835

## Do Not Translate (Locale Additions)

- `Sealcode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `sealcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Sealcode` in prose, `sealcode` only for exact technical identifiers
...
- Avoid changing `sealcode` to `Sealcode` inside commands, URLs, package names, or code literals
