---
title: Teilen
description: Teile Sealcode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Sealcode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Sealcode Folgendes:
...
Sealcode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Sealcode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`sealcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du sealcode in deiner Organisation einsetzt.
