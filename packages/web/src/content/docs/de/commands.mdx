...
Erstellen Sie `.sealcode/commands/test.md`:

```md title=".sealcode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Sealcode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Sealcode [config](/docs/config):

```json title="sealcode.jsonc" {4-12}
{
...
- Global: `~/.config/sealcode/commands/`
- Pro Projekt: `.sealcode/commands/`

```markdown title="~/.config/sealcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".sealcode/commands/component.md"
---
...
```md title=".sealcode/commands/create-file.md"
---
...
```md title=".sealcode/commands/analyze-coverage.md"
---
...
```md title=".sealcode/commands/review-changes.md"
---
...
```md title=".sealcode/commands/review-component.md"
---
...
Sealcode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
