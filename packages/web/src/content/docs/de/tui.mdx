---
title: TUI
description: Arbeite mit Sealcode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Sealcode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Sealcode die TUI im aktuellen Verzeichnis.
...
In der Sealcode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Sealcode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Sealcode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `sealcode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `SEALCODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
