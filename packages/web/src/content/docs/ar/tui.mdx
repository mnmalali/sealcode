---
title: TUI
description: استخدام واجهة المستخدم TUI في Sealcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Sealcode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Sealcode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Sealcode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Sealcode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Sealcode. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Sealcode.
...
استخدم `SEALCODE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
