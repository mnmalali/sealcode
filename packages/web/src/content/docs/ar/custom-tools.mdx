...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في sealcode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في sealcode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.sealcode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/sealcode/tools/`.
