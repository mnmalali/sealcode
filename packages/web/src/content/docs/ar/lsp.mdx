---
title: خوادم LSP
description: يتكامل Sealcode مع خوادم LSP لديك.
---

يتكامل Sealcode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Sealcode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `SEALCODE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات sealcode.
