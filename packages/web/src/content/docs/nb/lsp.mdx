---
title: LSP-servere
description: sealcode integreres med LSP-serverne dine.
---

Sealcode integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

Sealcode kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `SEALCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når sealcode åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i Sealcode-konfigurasjonen.
