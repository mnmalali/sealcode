...
Agentferdigheter lar Sealcode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går sealcode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
sealcode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `sealcode.json`:
