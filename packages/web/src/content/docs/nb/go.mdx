...
Sealcode Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
Sealcode Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i Sealcode. Du abonnerer på Sealcode Go og
...
Sealcode Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

Sealcode Go fungerer som enhver annen leverandør i Sealcode.

1. Du logger inn på **<a href={console}>Sealcode Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Sealcode Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Sealcode Go.
:::
...
Sealcode Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Sealcode-konfigurasjon
bruker formatet `sealcode-go/<model-id>`. For eksempel, for Kimi K2.6, vil du
bruke `sealcode-go/kimi-k2.6` i konfigurasjonen din.
...
Vi opprettet Sealcode Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Sealcode også.
