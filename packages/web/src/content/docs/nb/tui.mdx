---
title: TUI
description: Bruke sealcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Sealcode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Sealcode starter TUI for gjeldende katalog.
...
Når du bruker Sealcode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Sealcode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Sealcode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `sealcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `SEALCODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
