...
Crear `.sealcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Sealcode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Sealcode [config](/docs/config):
...
- Por proyecto: `.sealcode/commands/`
...
sealcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
