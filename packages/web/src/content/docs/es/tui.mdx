---
title: TUI
description: Usando la interfaz de usuario del terminal Sealcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Sealcode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Sealcode se inicia TUI para el directorio actual.
...
Cuando utilice Sealcode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Sealcode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Sealcode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `sealcode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `SEALCODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
