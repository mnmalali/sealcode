...
Brug den til at bygge integrasjoner og kontrollere sealcode programmatisk.
...
Opret en forekomst av sealcode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `sealcode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av sealcode, kan du oprete en klientforekomst for at koble til den:
