...
Agentferdigheter lar Sealcode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Sealcode søker etter disse stedene:

- Prosjektkonfigurasjon: `.sealcode/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/sealcode/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Sealcode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.sealcode/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/sealcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.sealcode/skills/git-release/SKILL.md` slik:
...
Sealcode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `sealcode.json`:
...
**For innebygde agenter** (i `sealcode.json`):
