...
Opret `.sealcode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Sealcode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Sealcode [config](/docs/config):
...
- Globalt: `~/.config/sealcode/commands/`
- Pr. projekt: `.sealcode/commands/`
...
sealcode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
