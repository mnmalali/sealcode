...
Her er alle de innebygde verktøyene som er tilgængelige i Sealcode.
...
:::note
Dette verktøyet er bare tilgængelig når `SEALCODE_EXPERIMENTAL_LSP_TOOL=true` (eller `SEALCODE_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Sealcode-leverandøren eller når miljøvariabelen `SEALCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
