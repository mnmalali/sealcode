---
title: TUI
description: Brug af Sealcode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Sealcode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Sealcode starter TUI for den nuværende mappe.
...
Når du bruger Sealcode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Sealcode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Sealcode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `sealcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `SEALCODE_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
