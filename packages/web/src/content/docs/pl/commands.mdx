...
Utwórz `.sealcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `sealcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji sealcode:
...
- Globalnie: `~/.config/sealcode/commands/`
- Na projekt: `.sealcode/commands/`
...
sealcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
