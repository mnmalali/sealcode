---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala sealcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

sealcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie sealcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI sealcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do sealcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij sealcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `sealcode.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `SEALCODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
