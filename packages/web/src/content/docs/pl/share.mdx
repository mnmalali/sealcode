---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące sealcode.
---

Funkcja udostępniania sealcode umożliwia tworzenie publicznych linków do konwersacji sealcode, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, sealcode:
...
sealcode obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie sealcode korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `sealcode.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu sealcode w Twojej organizacji.
