---
title: Zen
description: Liste organisée de modèles fournis par Sealcode.
---
...
Sealcode Zen est une liste de modèles testés et vérifiés fournie par l'équipe Sealcode.

:::note
Sealcode Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans Sealcode. Vous vous connectez à Sealcode Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Sealcode.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Sealcode.
:::
...
Sealcode Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

Sealcode Zen fonctionne comme n'importe quel autre fournisseur dans Sealcode.

1. Vous vous connectez à **<a href={console}>Sealcode Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez Sealcode Zen et collez votre clé API.
...
| ---------------------- | ---------------------- | -------------------------------------------------- | --------------------------- |
| GPT 5.5                | gpt-5.5                | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.5 Pro            | gpt-5.5-pro            | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4                | gpt-5.4                | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Pro            | gpt-5.4-pro            | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Mini           | gpt-5.4-mini           | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Nano           | gpt-5.4-nano           | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex          | gpt-5.3-codex          | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark    | gpt-5.3-codex-spark    | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2                | gpt-5.2                | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex          | gpt-5.2-codex          | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1                | gpt-5.1                | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex          | gpt-5.1-codex          | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max      | gpt-5.1-codex-max      | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini     | gpt-5.1-codex-mini     | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5                  | gpt-5                  | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex            | gpt-5-codex            | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano             | gpt-5-nano             | `https://github.com/mnmalali/sealcode/zen/v1/responses`             | `@ai-sdk/openai`            |
| Claude Opus 4.7        | claude-opus-4-7        | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.6        | claude-opus-4-6        | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5        | claude-opus-4-5        | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1        | claude-opus-4-1        | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6      | claude-sonnet-4-6      | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5      | claude-sonnet-4-5      | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4        | claude-sonnet-4        | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5       | claude-haiku-4-5       | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5       | claude-3-5-haiku       | `https://github.com/mnmalali/sealcode/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3.1 Pro         | gemini-3.1-pro         | `https://github.com/mnmalali/sealcode/zen/v1/models/gemini-3.1-pro` | `@ai-sdk/google`            |
| Gemini 3 Flash         | gemini-3-flash         | `https://github.com/mnmalali/sealcode/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| Qwen3.6 Plus           | qwen3.6-plus           | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3.5 Plus           | qwen3.5-plus           | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5           | minimax-m2.5           | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5 Free      | minimax-m2.5-free      | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.7           | minimax-m2.7           | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5.1                | glm-5.1                | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5                  | glm-5                  | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5              | kimi-k2.5              | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.6              | kimi-k2.6              | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle             | big-pickle             | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash Free | deepseek-v4-flash-free | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free  | nemotron-3-super-free  | `https://github.com/mnmalali/sealcode/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Le [model id](/docs/config/#models) dans votre configuration Sealcode utilise le format `sealcode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `sealcode/gpt-5.5` dans votre configuration.
...
```
https://github.com/mnmalali/sealcode/zen/v1/models
```
...
- DeepSeek V4 Flash Free est disponible sur Sealcode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiniMax M2.5 Free est disponible sur Sealcode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur Sealcode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur Sealcode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé Sealcode Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec Sealcode également.
