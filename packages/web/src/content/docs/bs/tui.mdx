---
title: TUI
description: Korištenje korisničkog interfejsa Sealcode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Sealcode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Sealcode pokreće TUI za trenutni direktorij.
...
Kada koristite Sealcode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Sealcode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Sealcode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `sealcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `SEALCODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
