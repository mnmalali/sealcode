...
Agent skills omogucavaju Sealcode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Sealcode pretrazuje ove lokacije:

- Konfiguracija projekta: `.sealcode/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/sealcode/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Sealcode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.sealcode/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/sealcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.sealcode/skills/git-release/SKILL.md` ovako:
...
Sealcode navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `sealcode.json`:
...
**Za ugradene agente** (u `sealcode.json`):
