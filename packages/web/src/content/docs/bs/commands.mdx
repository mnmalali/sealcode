...
Kreiraj `.sealcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz Sealcode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Sealcode [config](/docs/config):
...
- Globalno: `~/.config/sealcode/commands/`
- Po projektu: `.sealcode/commands/`
...
Sealcode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
