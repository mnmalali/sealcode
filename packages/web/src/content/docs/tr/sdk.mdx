---
title: SDK
description: sealcode sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

sealcode JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
sealcode'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `sealcode.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir sealcode örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
