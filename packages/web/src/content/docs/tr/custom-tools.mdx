---
title: Özel Araçlar
description: LLM'un sealcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. sealcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.sealcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/sealcode/tools/` içine yerleştirerek.
