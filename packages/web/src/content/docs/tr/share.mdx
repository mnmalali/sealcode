---
title: Paylasim
description: sealcode konusmalarini genel baglantilarla paylasin.
---

sealcode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda sealcode:
...
sealcode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak sealcode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `sealcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda sealcode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
