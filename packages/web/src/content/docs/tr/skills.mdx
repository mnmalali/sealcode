...
Ajan becerileri, sealcode'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
sealcode su konumlari tarar:

- Proje konfigurasyonu: `.sealcode/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/sealcode/skills/<name>/SKILL.md`
...
Proje yerel yollarinda sealcode, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.sealcode/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/sealcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.sealcode/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
sealcode, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`sealcode.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`sealcode.json` icinde):
