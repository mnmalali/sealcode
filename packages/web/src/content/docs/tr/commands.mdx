...
`.sealcode/commands/test.md` oluştur:
...
sealcode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

sealcode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/sealcode/commands/`
- Proje başına: `.sealcode/commands/`
...
sealcode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
