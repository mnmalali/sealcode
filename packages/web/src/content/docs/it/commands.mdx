...
Crea `.sealcode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Sealcode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Sealcode:
...
- Globale: `~/.config/sealcode/commands/`
- Per progetto: `.sealcode/commands/`
...
sealcode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
