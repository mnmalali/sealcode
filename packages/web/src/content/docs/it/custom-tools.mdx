...
description: Crea strumenti che l'LLM puo chiamare in sealcode.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di sealcode come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.sealcode/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/sealcode/tools/`.
