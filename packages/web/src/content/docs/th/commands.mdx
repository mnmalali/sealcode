...
สร้าง `.sealcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Sealcode:
...
- ระดับผู้ใช้ (Global): `~/.config/sealcode/commands/`
- ระดับโปรเจ็กต์: `.sealcode/commands/`
...
Sealcode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
