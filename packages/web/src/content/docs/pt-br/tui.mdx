---
title: TUI
description: Usando a interface de usuário de terminal sealcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O sealcode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar sealcode inicia o TUI para o diretório atual.
...
Ao usar o TUI do sealcode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao sealcode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do sealcode. _Aliases_: `/quit`, `/q`
...
Isso é separado do `sealcode.json`, que configura o comportamento do servidor/runtime.
...
Use `SEALCODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
