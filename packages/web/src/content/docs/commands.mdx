...
Create `.sealcode/commands/test.md`:
...
You can add custom commands through the Sealcode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Sealcode [config](/docs/config):
...
sealcode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
