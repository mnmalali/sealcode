...
import { IconSealcode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "sealcode/session/message-v2"
import type { Message } from "sealcode/session/message"
import type { Session } from "sealcode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.sealcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.sealcode_name}>
                    <IconSealcode width={16} height={16} />
                  </div>
