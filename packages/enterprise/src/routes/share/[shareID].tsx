import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@sealcode-ai/sdk/v2"
import { SessionTurn } from "@sealcode-ai/ui/session-turn"
import { SessionReview } from "@sealcode-ai/ui/session-review"
import { DataProvider } from "@sealcode-ai/ui/context"
import { FileComponentProvider } from "@sealcode-ai/ui/context/file"
import { WorkerPoolProvider } from "@sealcode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@sealcode-ai/ui/logo"
import { IconButton } from "@sealcode-ai/ui/icon-button"
import { ProviderIcon } from "@sealcode-ai/ui/provider-icon"
import { iife } from "@sealcode-ai/core/util/iife"
import { Binary } from "@sealcode-ai/core/util/binary"
import { NamedError } from "@sealcode-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@sealcode-ai/ui/tabs"
import { MessageNav } from "@sealcode-ai/ui/message-nav"
import { FileSSR } from "@sealcode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@sealcode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/sealcode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Sealcode</Title>
              </Show>
              <Meta name="description" content="sealcode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/mnmalali/sealcode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://github.com/mnmalali/sealcode/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
