...
import desktopAppIcon from "../../asset/lander/sealcode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://github.com/mnmalali/sealcode/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>github.com/mnmalali/sealcode/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g sealcode-ai")}>
                <code>
                  npm i -g <strong>sealcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g sealcode-ai")}>
                <code>
                  bun add -g <strong>sealcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install mnmalali/tap/sealcode")}>
                <code>
                  brew install <strong>mnmalali/tap/sealcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S sealcode")}>
                <code>
                  paru -S <strong>sealcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask sealcode-desktop")}>
                <code>
                  brew install --cask <strong>sealcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
