...
import compareVideo from "../../asset/lander/sealcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/sealcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="sealcode:auth" content={loggedin() ? "true" : "false"} />
