...
import { Database, eq, and, isNull } from "@sealcode-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@sealcode-ai/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#sealcode-go")} target="_blank" rel="noopener noreferrer">
