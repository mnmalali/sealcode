...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new SealcodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Sealcode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Sealcode system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Sealcode configuration settings and preferences.
   */
   ...
   *
   * Update global Sealcode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Sealcode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Sealcode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Sealcode instances, releasing all resources.
   */
   ...
   * Upgrade sealcode
   *
   * Upgrade sealcode to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Sealcode configuration settings and preferences.
   */
   ...
   *
   * Update Sealcode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Sealcode state.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Sealcode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Sealcode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Sealcode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Sealcode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Sealcode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Sealcode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Sealcode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Sealcode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class SealcodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<SealcodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    SealcodeClient.__registry.set(this, args?.key)
  }
