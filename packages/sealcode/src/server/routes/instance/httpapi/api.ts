...
export const RootHttpApi = HttpApi.make("sealcode-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("sealcode-instance")
...
export const SealcodeHttpApi = HttpApi.make("sealcode")
