...
>()("@sealcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@sealcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.SEALCODE_WORKSPACE_ID ? WorkspaceID.make(Flag.SEALCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-sealcode-directory"] || process.cwd()
}
