...
export const UI_UPSTREAM = new URL("https://app.github.com/mnmalali/sealcode")
...
export function embeddedUI(disableEmbeddedWebUi: boolean) {
  ...
  return (embeddedUIPromise ??=
    ...
    import("sealcode-web-ui.gen.ts").then((module) => module.default as Record<string, string>).catch(() => null))
}
