...
import { Slug } from "@sealcode-ai/core/util/slug"
...
export class Service extends Context.Service<Service, Interface>()("@sealcode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        SEALCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        SEALCODE_WORKSPACE_ID: config.id,
        SEALCODE_EXPERIMENTAL_WORKSPACES: "true",
