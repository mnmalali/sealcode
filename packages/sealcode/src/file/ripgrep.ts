...
import { sanitizedProcessEnv } from "@sealcode-ai/core/util/sealcode-process"
import { which } from "@/util/which"
import { NonNegativeInt } from "@sealcode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@sealcode/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".sealcode")) continue
