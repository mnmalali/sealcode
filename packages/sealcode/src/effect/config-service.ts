 ...
 *   "@sealcode/ServerAuthConfig",
 *   {
 *     password: Config.string("SEALCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("SEALCODE_SERVER_USERNAME").pipe(Config.withDefault("sealcode")),
 *   },
 * ) {}
 *
