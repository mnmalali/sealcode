...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@sealcode-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderID.sealcode || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@sealcode/ToolRegistry") {}
