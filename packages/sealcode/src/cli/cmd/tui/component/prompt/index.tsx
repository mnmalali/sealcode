...
import type { AssistantMessage, FilePart, UserMessage } from "@sealcode-ai/sdk/v2"
...
import { useBindings, useCommandShortcut, useLeaderActive, useSealcodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.SEALCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
