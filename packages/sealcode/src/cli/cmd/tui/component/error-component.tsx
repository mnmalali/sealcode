...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/mnmalali/sealcode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("sealcode-version", InstallationVersion)
