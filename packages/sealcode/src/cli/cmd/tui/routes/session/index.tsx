...
const GO_UPSELL_PROVIDERS = new Set(["sealcode", "sealcode-go"])
  ...
  createEffect(() => {
    ...
    return exit.message.set(
      [
        ...
        `  ${weak("Continue")}${UI.Style.TEXT_NORMAL_BOLD}sealcode -s ${session()?.id}${UI.Style.TEXT_NORMAL}`,
        ``,
      ].join("\n"),
    )
  })
...
function ReasoningPart(props: { last: boolean; part: ReasoningPart; message: AssistantMessage }) {
  ...
  // OpenAI / Copilot / sealcode-via-OpenAI emit `**Title**\n\n<body>` summary
