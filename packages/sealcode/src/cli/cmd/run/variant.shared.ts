...
//
// The saved variant persists across sessions in ~/.local/state/sealcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@sealcode/RunVariant") {}
