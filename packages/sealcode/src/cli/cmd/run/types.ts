...
import type { SealcodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@sealcode-ai/sdk/v2"
...
type PromptModel = Parameters<SealcodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<SealcodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<SealcodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<SealcodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<SealcodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<SealcodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<SealcodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<SealcodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<SealcodeClient["question"]["reject"]>[0]
