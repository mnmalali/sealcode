...
import type { Event, GlobalEvent, SealcodeClient } from "@sealcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@sealcode/RunStreamTransport") {}
