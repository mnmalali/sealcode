...
// sealcode and the HTTP event stream still expect legacy bus/sync payloads.
...
import "@sealcode-ai/core/catalog"
import "@sealcode-ai/core/session-event"
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@sealcode/EventV2Bridge") {}
