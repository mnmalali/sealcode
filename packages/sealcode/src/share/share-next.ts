import type * as SDK from "@sealcode-ai/sdk/v2"
...
const disabled = process.env["SEALCODE_DISABLE_SHARE"] === "true" || process.env["SEALCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@sealcode/ShareNext") {}
