...
Practical reference for the current tool-migration state in `packages/sealcode`.
...
Tool tests should use the existing Effect helpers in `packages/sealcode/test/lib/effect.ts`:
