...
How we write Effect code in `packages/sealcode`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@sealcode/Foo") {}
...
Read sealcode runtime flags through
