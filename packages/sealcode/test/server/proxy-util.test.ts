...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips sealcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-sealcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-sealcode-directory")).toBeNull()
      expect(result.get("x-sealcode-workspace")).toBeNull()
