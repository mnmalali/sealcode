...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips sealcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-sealcode-directory"]).toBeUndefined()
      expect(forwarded["x-sealcode-workspace"]).toBeUndefined()
