...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/sealcode.git")).toEqual({ owner: "sst", repo: "sealcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/sealcode")).toEqual({ owner: "sst", repo: "sealcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/sealcode.git")).toEqual({ owner: "sst", repo: "sealcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/sealcode")).toEqual({ owner: "sst", repo: "sealcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/sealcode.git")).toEqual({ owner: "sst", repo: "sealcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/sealcode")).toEqual({ owner: "sst", repo: "sealcode" })
})
