...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SEALCODE_CALLER", () => {
    process.env["SEALCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SEALCODE_CALLER", () => {
    process.env["SEALCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SEALCODE_CALLER", () => {
    process.env["SEALCODE_CALLER"] = "unknown"
