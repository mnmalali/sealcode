...
import { ensureProcessMetadata } from "../util/sealcode-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    serviceName: "sealcode",
    serviceVersion: InstallationVersion,
    attributes: {
      ...attributes,
      "deployment.environment.name": InstallationChannel,
      "sealcode.client": Flag.SEALCODE_CLIENT,
      "sealcode.process_role": processMetadata.processRole,
      "sealcode.run_id": processMetadata.runID,
