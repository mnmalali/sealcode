...
// test/preload.ts pins SEALCODE_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.SEALCODE_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.SEALCODE_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.SEALCODE_MODELS_PATH = undefined
  Flag.SEALCODE_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.SEALCODE_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.SEALCODE_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
