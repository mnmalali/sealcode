import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@sealcode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
