export const dict = {
  ...
  "dialog.provider.sealcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.sealcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.sealcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Sealcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Sealcode.",
  ...
  "provider.connect.sealcodeZen.line1":
    "Sealcode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.sealcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.sealcodeZen.visit.link": "github.com/mnmalali/sealcode/zen",
  "provider.connect.sealcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Sealcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Sealcode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w sealcode.json",
  ...
  "dialog.server.description": "Przełącz serwer Sealcode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Sealcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Sealcode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (sealcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Sealcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Sealcode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Sealcode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Sealcode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Sealcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Sealcode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Sealcode.",
