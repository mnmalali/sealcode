...
export const dict = {
  ...
  "dialog.provider.sealcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.sealcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.sealcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Sealcode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Sealcode.",
  ...
  "provider.connect.sealcodeZen.line1":
    "Sealcode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.sealcodeZen.visit.prefix": "Besøk ",
  "provider.connect.sealcodeZen.visit.link": "github.com/mnmalali/sealcode/zen",
  "provider.connect.sealcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Sealcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Sealcode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i sealcode.json",
  ...
  "dialog.server.description": "Bytt hvilken Sealcode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Sealcode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Sealcode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (sealcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Sealcode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Sealcode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Sealcode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Sealcode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Sealcode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Sealcode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Sealcode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Sealcode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Sealcode.",
