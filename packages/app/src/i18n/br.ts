export const dict = {
  ...
  "dialog.provider.sealcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.sealcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.sealcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Sealcode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Sealcode.",
  ...
  "provider.connect.sealcodeZen.line1":
    "Sealcode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.sealcodeZen.visit.prefix": "Visite ",
  "provider.connect.sealcodeZen.visit.link": "github.com/mnmalali/sealcode/zen",
  "provider.connect.sealcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Sealcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Sealcode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em sealcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Sealcode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Sealcode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Sealcode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (sealcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Sealcode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sealcode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Sealcode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Sealcode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Sealcode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Sealcode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Sealcode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Sealcode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Sealcode.",
