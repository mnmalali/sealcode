export const dict = {
  ...
  "dialog.provider.sealcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.sealcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.sealcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Sealcode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Sealcode-u.",
  ...
  "provider.connect.sealcodeZen.line1":
    "Sealcode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.sealcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.sealcodeZen.visit.link": "github.com/mnmalali/sealcode/zen",
  "provider.connect.sealcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Sealcode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Sealcode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u sealcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se Sealcode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Sealcode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Sealcode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (sealcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Sealcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Sealcode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Sealcode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Sealcode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Sealcode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Sealcode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Sealcode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Sealcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Sealcode-a.",
