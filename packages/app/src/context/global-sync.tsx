...
export const loadMcpQuery = (directory: string, sdk: SealcodeClient) =>
  queryOptions({
    queryKey: [directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (directory: string, sdk: SealcodeClient) =>
  queryOptions({
    queryKey: [directory, "lsp"] as const,
    queryFn: () => sdk.lsp.status().then((r) => r.data ?? []),
  })

function makeQueryOptionsApi(globalSDK: () => SealcodeClient, sdkFor: (dir: PathKey) => SealcodeClient) {
  return {
...
function createGlobalSync() {
  ...
  const sdkCache = new Map<string, SealcodeClient>()
