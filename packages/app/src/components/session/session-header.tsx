import { AppIcon } from "@sealcode-ai/ui/app-icon"
...
import { Keybind } from "@sealcode-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_SEALCODE_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("sealcode-titlebar-center"))
    setRightMount(document.getElementById("sealcode-titlebar-right"))
  })
