import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@sealcode-ai/sdk/v2/client"
import { Button } from "@sealcode-ai/ui/button"
import { useDialog } from "@sealcode-ai/ui/context/dialog"
import { Dialog } from "@sealcode-ai/ui/dialog"
import { Icon } from "@sealcode-ai/ui/icon"
import { IconButton } from "@sealcode-ai/ui/icon-button"
import { List, type ListRef } from "@sealcode-ai/ui/list"
import { ProviderIcon } from "@sealcode-ai/ui/provider-icon"
import { Spinner } from "@sealcode-ai/ui/spinner"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "sealcode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.sealcodeZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.sealcodeZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.sealcodeZen.visit.prefix")}
                <Link href="https://github.com/mnmalali/sealcode/zen" tabIndex={-1}>
                  {language.t("provider.connect.sealcodeZen.visit.link")}
                </Link>
                {language.t("provider.connect.sealcodeZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
