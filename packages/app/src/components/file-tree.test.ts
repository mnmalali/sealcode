...
beforeAll(async () => {
  ...
  mock.module("@sealcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@sealcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@sealcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@sealcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
