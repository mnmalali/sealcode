...
import { base64Encode } from "@sealcode-ai/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@sealcode-ai/ui/resize-handle"
...
import { DropdownMenu } from "@sealcode-ai/ui/dropdown-menu"
import { Dialog } from "@sealcode-ai/ui/dialog"
import { getFilename } from "@sealcode-ai/core/util/path"
import { Session, type Message } from "@sealcode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@sealcode-ai/ui/toast"
...
import { retry } from "@sealcode-ai/core/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/mnmalali/sealcode/desktop-feedback")}
      renderPanel={() =>
