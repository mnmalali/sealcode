...
Internal package; depended on as `@sealcode-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@sealcode-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@sealcode-ai/http-recorder"
