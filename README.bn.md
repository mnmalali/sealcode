...
# Package managers
npm i -g sealcode-ai@latest        # or bun/pnpm/yarn
scoop install sealcode             # Windows
choco install sealcode             # Windows
brew install mnmalali/tap/sealcode # macOS and Linux (recommended, always up to date)
brew install sealcode              # macOS and Linux (official brew formula, updated less)
sudo pacman -S sealcode            # Arch Linux (Stable)
paru -S sealcode-bin               # Arch Linux (Latest from AUR)
mise use -g sealcode               # Any OS
nix run nixpkgs#sealcode           # or github:mnmalali/sealcode for latest dev branch
```
...
1. `$SEALCODE_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.sealcode/bin` - ডিফল্ট ফলব্যাক
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://github.com/mnmalali/sealcode/docs/agents)।
...
**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/sealcode) | [X.com](https://x.com/sealcode)
