...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/mnmalali/sealcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for mnmalali/sealcode...\n")
...
console.log("Fetching npm all-time downloads for sealcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("sealcode-ai")
