...
Generates UPCOMING_CHANGELOG.md by running the sealcode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for sealcode run (default: low)
      --quiet            Suppress sealcode command output unless it fails
